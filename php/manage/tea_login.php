...
<html lang="zh-CN">
  ...
  <!-- 主要内容 -->
  <div class="form-are">
   <h3 class="text-center">欢迎老师使用湖理小助手</h3>
   <br>
   <br>
    <form class="form-horizontal" role="form" action="tea_login_sub.php" method="post">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          <a type="button" class="btn btn-success btn-block btn-lg" href="reg_tea.php">注册</a>
        </div>
      </div>
    </form>
  </div>
