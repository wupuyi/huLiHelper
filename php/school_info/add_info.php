      ...
      <table>
        <tr>
          ...
          <td width="33.3%" rowspan="9" align="center">
            <div class="photo-border">
              <img src="" alt="学籍照片" id="stu_photo" style="width: 132px;height: 172px">
            </div>
        ...
        <tr>
          ...
          <td width="33.3%">
            ...
            <input type="radio" name="sex" value="男" checked>男&nbsp&nbsp&nbsp&nbsp&nbsp
        ...
        <tr>
          <td width="33.3%" colspan="2">
            ...
            <input type="text" name="address" id="address" style="width: 544px">
          </td>
        </tr>
        <tr>
          <td width="33.3%">
        ...
        <tr>
          <td width="33.3%">
            ...
            <select name="edu_cate" id="edu_cate" style="width: 174px;height: 26px">
              <option value="普通(统招)">普通(统招)</option>
              <option value="普通专升本(统招)">普通专升本(统招)</option>
