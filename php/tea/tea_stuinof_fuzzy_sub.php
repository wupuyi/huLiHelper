...
// print_r($department);
// print_r($class);
$sql="SELECT stu_id,photo FROM stu_status WHERE grade='$grade' AND department='$department' AND class='$class'";
  ...
  <!-- 主要内容 -->
    <div class="body-div">  
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3><span class="label label-info" style="font-size: 16px;"><?php echo $department.$grade.$class; ?></span>查询结果如下：</h3>
          </div>          
        </div>
        <div class="row" id="search_result">
            ...
            //验证查询结果是否存在
            if (empty($rows)) {          
                  echo '<script type="text/javascript">alert("查无结果！");window.location="tea_stuinfo_welcome.php";</script>';
            }else{
